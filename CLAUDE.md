...
1. ✅ Использовать Poetry, UV или pip для зависимостей? (рекомендую UV - самый современный)
2. ✅ Docker образ нужен сразу или позже?
3. ✅ CI/CD pipeline (GitHub Actions, GitLab CI)?
4. ✅ Лицензия проекта (MIT, Apache 2.0, proprietary)?
5. ✅ Нужна ли поддержка прокси с аутентификацией?
6. ✅ Максимальный размер загружаемого файла (для PDF, изображений)?
...
3. Реализовать core модули (crawler, fetcher, parser)
4. Настроить SQLAlchemy модели
5. CLI интерфейс
6. Тесты
...
### Технические решения
_Будут документироваться по ходу разработки_
